const t: Language = {
  ...
  content: {
    ...
    acceptTos:
      'Иcпользуя сервис вы подтверждаете согласие с условиями использования YouTube API <a target="_self" href="https://www.youtube.com/static?template=terms">https://www.youtube.com/static?template=terms</a>',
  },
  messages: {
